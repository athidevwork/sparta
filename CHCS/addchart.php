					...
					while($cmd_get_rm_fee_array = mysql_fetch_array($cmd_get_rm_fee_query)){
						...
						if($cmd_get_vacate_rm_wo_fee_num_rows !=0){
							while($cmd_get_vacate_rm_wo_fee_array = mysql_fetch_array($cmd_get_vacate_rm_wo_fee)){
								...
								$no_of_day = ceil(abs(strtotime($cmd_get_vacate_rm_wo_fee_array_out_date) - strtotime($cmd_get_vacate_rm_wo_fee_array_in_date)) / 86400);
								if($no_of_day ==0)
									$no_of_day =1;
								$fee_tobe_paid = $no_of_day * $cmd_get_rm_fee;
