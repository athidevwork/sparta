...
?>
		...
		include("config_db2.php");
			$cmd_clinic_hist_query = mysql_query("select id,patient_id,complaints, dm, cad, asthma, seizure, bp, diagnosis, room_no, consultant,  create_date from clinical_history WHERE id ='$cno' order by id desc LIMIT 1");
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="panel panel-default tabs"> 
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">IP Patient List</a></li>
										<li><a href="#tab-second" role="tab" data-toggle="tab">OP Patient List</a></li>
