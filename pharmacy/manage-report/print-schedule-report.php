...
$pdf->MultiCell(13.5, 0.25, "VASANTHAM PHARMACY" , '0', "C");
//$pdf->SetFont('Times','B',12);
//$pdf->MultiCell(13.5, 0.25, "(Unit of Murugan Hospitals)" , '0', "C");
$pdf->SetFont('Times','I',12);
$pdf->MultiCell(13.5, 0.25, "Old No. 1/114, New No.6/71" , '0', "C");
$pdf->MultiCell(13.5, 0.25, "Pillaiyar Koil Street, Ayyappanthangal,CH-600 056.", '0', "C");
$pdf->MultiCell(13.5, 0.25, "Phone : 7401530644, 9941610087" , '0', "C");

$pdf->SetFont('Times','B',15);
$pdf->MultiCell(13.5, 0.25, "DL No  : 587/KPM/20/21" , '0', "C");
